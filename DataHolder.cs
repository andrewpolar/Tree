...
namespace Tree
{
    ...
    class DataHolder
	{
        ...
        public int[] _NUMBER_OF_BLOCKS = null;
        ...
        {
            _NUMBER_OF_BLOCKS = new int[] { 8, 8, 8, 8, 8};
        ...
        {
            _NUMBER_OF_BLOCKS = new int[] { 10, 10, 10, 10, 10 };
        ...
        public void BuildBankChurnData()
        {
            ...
            _NUMBER_OF_BLOCKS = new int[] { 4, 3, 2, 5, 7, 10, 5, 2, 2, 8 };
        ...
        {
            _NUMBER_OF_BLOCKS = new int[] { 6, 4, 10, 2, 9, 2, 2, 2, 12, 2, 5, 4, 4, 9, 9, 2, 4, 3, 5, 9, 6, 7 };
